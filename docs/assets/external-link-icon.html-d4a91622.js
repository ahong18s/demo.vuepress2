import{_ as r,r as i,o,c,d as a,a as e,b as n,w as u,e as l}from"./app-09910f35.js";const p={},h=e("h1",{id:"external-link-icon",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#external-link-icon","aria-hidden":"true"},"#"),n(" external-link-icon")],-1),v=l(`<p>This plugin has been integrated into the default theme.</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>npm i -D @vuepress/plugin-external-link-icon@next
