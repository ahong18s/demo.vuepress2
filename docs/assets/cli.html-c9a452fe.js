import{_ as p,r as t,o,c,d as a,a as s,b as e,w as d,e as i}from"./app-2fe2c728.js";const u={},v=s("h1",{id:"命令行接口",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#命令行接口","aria-hidden":"true"},"#"),e(" 命令行接口")],-1),m={href:"https://www.npmjs.com/package/@vuepress/cli",target:"_blank",rel:"noopener noreferrer"},b={href:"https://www.npmjs.com/package/vuepress",target:"_blank",rel:"noopener noreferrer"},h=i(`<p>执行 <code>vuepress --help</code> 来获取下列帮助信息：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Usage:
...
Options:
  ...
  -v, <span class="token parameter variable">--version</span>          Display version number 
  -h, <span class="token parameter variable">--help</span>             Display this message
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">提示</p><p>通过命令行设置的配置项，会覆盖你配置文件中的同名配置项。</p></div><h2 id="info" tabindex="-1"><a class="header-anchor" href="#info" aria-hidden="true">#</a> info</h2><p>输出当前系统和依赖相关的信息。</p><p>在你想要检查你的环境，或者提交 Issue 时候，可以使用该命令。</p>`,5);function x(D,S){const l=t("NpmBadge"),n=t("ExternalLinkIcon"),r=t("RouterLink");return o(),c("div",null,[v,a(l,{package:"@vuepress/cli"}),s("p",null,[e("VuePress 命令行接口是由 "),s("a",m,[e("@vuepress/cli"),a(n)]),e(" 包提供的。它包含在 "),s("a",b,[e("vuepress"),a(n)]),e(" 包之中，当然你也可以单独安装它。")]),h,s("div",k,[f,s("p",null,[e("VuePress 使用了 "),s("a",g,[e("debug"),a(n)]),e(" 模块。")]),_]),y,s("p",null,[e("将你的 VuePress 站点构建成静态文件，以便你进行后续"),a(r,{to:"/guide/deployment.html"},{default:d(()=>[e("部署")]),_:1}),e("。")]),w])}const B=p(u,[["render",x],["__file","cli.html.vue"]]);export{B as default};
